...
| <br>[**Primal-Dual iLQR for GPU-Accelerated Learning and Control in Legged Robots**](https://arxiv.org/abs/2506.07823)<br> | RA-L | 2026 | `[GPU-parallel] [iLQR]` Introduces a JAX/GPU MPC implementation for legged robots using primal-dual KKT solves with parallel scans, enabling learning with MPC in the loop across batched environments. | [GitHub](https://github.com/iit-DLSLab/mpx) | - |
| <br>[**Real-Time Whole-Body Control of Legged Robots with Model-Predictive Path Integral Control**](https://arxiv.org/abs/2409.10469)<br> | ICRA | 2025 | `[test-time] [MPPI]` Deploys whole-body sampling-based MPC for real-time legged locomotion and manipulation on hardware, using parallel trajectory sampling for online control. | [GitHub](https://github.com/jrapudg/RTWholeBodyMPPI) | [Project](https://whole-body-mppi.github.io/) |
...
| **MPX** | GPU MPC / trajectory-optimization accelerator | JAX library for legged robot MPC and trajectory optimization with temporal and state-space GPU parallelism, autodiff, and batched RL-style environments. | Python, JAX, MJX | [GitHub](https://github.com/iit-DLSLab/mpx) |
